  ...
  <div id="compare-chart-container">
    ...
    >
      ...
      <g id="discharge-annotations">
        <g class="discharge-annotation-2011">
          <text
            class="annotation discharge"
            transform="translate(323 224.6)"
          >Large spring melt</text>
          <polyline
            class="annotation-line"
            points="300.5 248 319 229.5 414 229.5"
          />
        </g>
        <g class="discharge-annotation-2012">
          <text
            class="annotation discharge"
            transform="translate(584 364.7)"
          >Smaller and earlier <tspan
            x="0"
            y="13.2"
          >spring melt</tspan></text>
          <polyline
            class="annotation-line"
            points="542.3 421.3 580 383.5 675 383.5"
          />
        </g>
        <g class="discharge-annotation-2012">
          <text
...
export default {
    ...
    methods: {
        ...
        animateAreas(){
          ...
          tl.to("#swe-reveal-rect", {duration: 3, delay: 1, x: "45%", ease: "none"}); // reveal area
          // then add 2011 swe annotations
          tl.from(".swe-annotation-2011", { duration: 1, opacity: 0, scale: 0.8, ease: "back", stagger: 1})
          //then do 2011 discharge area
           tl.to("#discharge-reveal-rect", {duration: 3, width: "45%", ease: "none"}); // reveal area
          ...
          tl.to("#swe-reveal-rect", {duration: 3, delay: 1, x: "90%", ease: "none"}); // reveal area
          // then add 2012 swe annotations
           tl.from(".swe-annotation-2012", { duration: 1, opacity: 0, scale: 0.8, ease: "back", stagger: 1})
