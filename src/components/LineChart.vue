<template>
  <div id="compare-chart-container">
    ...
    >
      ...
      <g id="xAxis">
        <g>
          <polyline class="axis-tick" points="64.9 111.2 64.9 307.5 733.6 307.5 733.6 110"/>
          <line class="axis-tick" x1="65.2" y1="310.3" x2="65.2" y2="315.1"/>
          <line class="axis-tick" x1="397.9" y1="310.3" x2="397.9" y2="315.1"/>
      ...
      <g id="hash-lines">       
            ...
            <line class="hash-line" x1="727" y1="241.7" x2="67" y2="241.7"/>
            <line class="hash-line" x1="727" y1="176.2" x2="67" y2="176.2"/>
            <line class="hash-line" x1="727" y1="110.8" x2="67" y2="110.8"/>
      </g>
      <g id="area-swe"
        mask="url(#sweMask)"
      >
