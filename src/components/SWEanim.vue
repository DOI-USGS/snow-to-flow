<template>
  ...
  <VizSection id="firstSection">
    ...
    <template v-slot:figures>
      ...
      ><svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1011 430">
       <image
