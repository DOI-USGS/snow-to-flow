    ...
    <template v-slot:figures>
      ...
      >
        <svg
          ...
          viewBox="0 0 1011 430"
        >
          <image
            xlink:href="@/assets/SWEanim/both_part.gif"
            height="100%"
            x="0"
            y="0"
          />
