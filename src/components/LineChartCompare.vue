  ...
  <div id="compare-chart-container">
    ...
    >
      ...
      <g id="yAxisDischarge">
        ...
        <text
          class="axis-label discharge"
          transform="translate(732.4 424.6)"
        >1</text>
        <text
          class="axis-label discharge"
          transform="translate(732.4 398.9)"
        >2</text>
        <text
          class="axis-label discharge"
          transform="translate(732.4 373.2)"
        >3</text>
        <text
          class="axis-label discharge"
        ...
        <text
          class="axis-label discharge"
          transform="translate(732.4 321.7)"
        >5</text>
        <text
          class="axis-label discharge"
          transform="translate(732.4 296)"
        >6</text>
        <text
          class="axis-label discharge"
          transform="translate(732.4 270.3)"
        >7</text>
        <text
          class="axis-label discharge"
          transform="translate(732.4 244.5)"
        >8</text>
        <text
          class="axis-label discharge"
