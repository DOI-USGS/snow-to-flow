  ...
  <div id="swe-chart-container">
    <svg id="swe-chart" viewBox="0 0 800 500">
        ...
        <g id="discharge-annotations">
            ...
            <g>
            <polyline class="annotation-line" points="589.9 406.1 608.4 387.6 703.4 387.6"/>
            <circle class="annotation-line" cx="587.7" cy="409.5" r="3.5"/>
            </g>
        </g>
    </svg>
  </div>
